# Node.js, MongoDB School Management System API
...
- **Testing with SwaggerUI:**
  ...
  - Added Swagger documentation (/api-docs).
...
Once the server is running, interact with the API using tools like [Swagger](https://swagger.io/) or integrate it into your application.
...
GitHub : [Muhammad Jameel](https://github.com/muhammadjameel0012)
