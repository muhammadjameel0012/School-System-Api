...
exports.logout = (req, res) => {
  ...
  sendSuccess(res, 200, 'You have been logged out.', null);
};
...
exports.restrictTo = (...permittedRoles) => (req, res, next) => {
  ...
  if (permittedRoles.includes(userRole)) {
    ...
    return sendError(res, 403, 'You don\'t have permission to perform this action.', null);
  }
};
...
exports.getAdminProfile = asyncHandler(async (req, res, next) => {
  ...
  sendSuccess(res, 200, 'Success', { admin });
});

exports.getAllAdmins = asyncHandler(async (req, res, next) => {
  const admins = await Admin.find()

  sendSuccess(res, 200, 'Success', admins);
});
...
exports.updateAdminData = asyncHandler(async (req, res, next) => {
  ...
  sendSuccess(res, 200, 'Success', { admin: updatedadmin });
});
