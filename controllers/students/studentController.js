...
const sendTokenResponse = (res, user, statusCode) => {
  ...
  sendSuccess(res, statusCode, 'Success', { token, user });
};
...
exports.getAllStudents = asyncHandler(async (req, res, next) => {
  ...
  sendSuccess(res, 200, 'Success', students);
});
...
exports.updateStudentData = asyncHandler(async (req, res, next) => {
  ...
  sendSuccess(res, 200, 'Success', { student: updatedStudent });
});
...
exports.adminUpdateStudent = asyncHandler(async (req, res, next) => {
  ...
  sendSuccess(res, 200, 'Success', { student: studentUpdated });
});
...
exports.writeExam = asyncHandler(async (req, res, next) => {
  ...
  if (
    ...
    await studentFound.save({ validateBeforeSave: false });
    return sendSuccess(res, 200, 'Exam submitted. Promoted to Level 300.', { examResults });
  }
  ...
  if (
    ...
    await studentFound.save({ validateBeforeSave: false });
    return sendSuccess(res, 200, 'Exam submitted. Promoted to Level 400.', { examResults });
  }
  ...
  if (
    ...
    await studentFound.save({ validateBeforeSave: false });
    return sendSuccess(res, 200, 'Exam submitted. Graduated.', { examResults });
  }

  sendSuccess(res, 200, 'Exam submitted successfully', { examResults });
});
